...
<div class="ibox-content">
              <form class="validate form-horizontal" method="POST" action="http://localhost/agendasurat/disposisiundangan?from=<?php echo $from?>">
                <?php
                  if(isset($_GET['ubah'])){
                          $parameter='ubah';
                          $where=array(
                          ...
                          $row=$this->db->get_where('disposisi_surat_masuk_undangan',$where)->row();
                          $id_disposisi_surat_masuk_undangan = $row->id_disposisi_surat_masuk_undangan;
                          ...
                          $parameter='tambah';
                          $id_disposisi_surat_masuk_undangan = '';
              ...
              ?>
                  <?php echo input_hidden('parameter',$parameter)?>
                        <?php echo input_hidden('id_disposisi_surat_masuk_undangan',$id_disposisi_surat_masuk_undangan,'','required');?>
...
<div class="ibox-content">
              <a href="http://localhost/agendasurat/disposisiundangan?tambah" class="btn btn-success"><i class="fa plus"></i> Tambah</a>
              <hr>
